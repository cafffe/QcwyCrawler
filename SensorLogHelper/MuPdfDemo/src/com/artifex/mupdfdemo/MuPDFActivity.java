...
public class MuPDFActivity extends Activity
{
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mPageGalley.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				/*Thread thread=new Thread(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						mDocView.setDisplayedViewIndex(position+1);
						mDocView.resetupChildren();
					}
				});
				thread.run();*/
				...
				mDocView.setDisplayedViewIndex(position+1);
				//mDocView.setDisplayedViewIndex(mPageSliderRes);
			}
		});
	...
	private void showButtons() {
		...
		if (!mButtonsVisible) {
			...
			//mPageGalley.setVisibility(View.VISIBLE);
			...
			anim.setAnimationListener(new Animation.AnimationListener() {
				public void onAnimationStart(Animation animation) {
					mPageSlider.setVisibility(View.INVISIBLE);//改动
				}
				public void onAnimationRepeat(Animation animation) {}
				public void onAnimationEnd(Animation animation) {
			...
			anim = new TranslateAnimation(0, 0, mPageGalley.getHeight(), 0);
			anim.setDuration(200);
			anim.setAnimationListener(new Animation.AnimationListener() {
				public void onAnimationStart(Animation animation) {
					mPageGalley.setVisibility(View.VISIBLE);
			...
			mPageGalley.startAnimation(anim);
		}
	}
	...
	private void hideButtons() {
		if (mButtonsVisible) {
			...
			hideKeyboard();
			//mPageGalley.setVisibility(View.INVISIBLE);
			...
			anim = new TranslateAnimation(0, 0, 0, mPageGalley.getHeight());
			anim.setDuration(200);
			anim.setAnimationListener(new Animation.AnimationListener() {
				public void onAnimationStart(Animation animation) {
					mPageGalley.setVisibility(View.INVISIBLE);
	...
	@SuppressLint("NewApi") private void makeButtonsView() {
		mButtonsView = getLayoutInflater().inflate(R.layout.buttons,null);
		//mFilenameView = (TextView)mButtonsView.findViewById(R.id.docNameText);
		mPageSlider = (SeekBar)mButtonsView.findViewById(R.id.pageSlider);
		mPageGalley=(Gallery)mButtonsView.findViewById(R.id.viewPage);
		mPageGalley.setAdapter(new ImageAdapter(this));
	...
	public class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			//image.setLayoutParams(new Gallery.LayoutParams(136, 88));
			return image;
		}
	}
}
